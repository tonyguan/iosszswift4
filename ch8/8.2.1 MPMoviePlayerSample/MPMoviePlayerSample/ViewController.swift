...
class ViewController: UIViewController {
    ...
    @IBAction func useMPMoviePlayerController(sender: AnyObject) {
        ...
        if self.moviePlayer == nil {
            ...
            NSNotificationCenter.defaultCenter().addObserver(self,
                selector: "didActiveAirPlay:",
                name: MPMoviePlayerIsAirPlayVideoActiveDidChangeNotification, object: nil)
    ...
    @IBAction func useMPMoviePlayerViewController(sender: AnyObject) {
        if self.moviePlayerView == nil {
            ...
            self.moviePlayerView.moviePlayer.allowsAirPlay = true
    ...
    func didActiveAirPlay(notification : NSNotification) {
        NSLog("AirPlay处于活动状态。")
    }
